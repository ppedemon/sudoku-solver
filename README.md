# Sudoku Solver
This repository hosts a [Rust](https://www.rust-lang.org) rendition of [Peter Norvig's Sudoku solver](https://norvig.com/sudoku.html), implemented using a DFS search and contraint propagation to reduce the search space.
